...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('test-notif', __webpack_require__(9));
    // router.addRoutes([
    //   {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        markAsRead: function markAsRead() {
            axios.patch('/nova-vendor/youpi-notifications/' + this.notification.id).then(function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        loadNotifications: function loadNotifications(callback) {
            ...
            axios.get('/nova-vendor/youpi-notifications/unread').then(function (response) {
        ...
        markAllAsRead: function markAllAsRead() {
            ...
            axios.patch('/nova-vendor/youpi-notifications').then(function () {
